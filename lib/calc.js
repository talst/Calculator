...
Calc.prototype.getStats = function() {
	...
	_.assign(data.stats, Calc.math.resists(this));
	...
	_.each(attrs, function(attr) {
		data.stats[attr] = this.attr(attr);
	}, this);
	return data;
};
...
Calc.math = {
	resists: function(calc) {
		...
		// ----------------------------------
		resists['resist-all'] = calc.attr('resist-all') + (calc.attr('intelligence') / 10);
		// ----------------------------------
		// Individual Resists (Resist + Resist All)
		// Formula: ( Resist All + Individual Resist )  * ( 1 + Bonus Resist All Percentage )
		// ----------------------------------
		resists['resist-physical'] = resists['resist-all'] + calc.attr('physical-resist');
		resists['resist-cold'] = resists['resist-all'] + calc.attr('cold-resist');
		resists['resist-fire'] = resists['resist-all'] + calc.attr('fire-resist');
		resists['resist-lightning'] = resists['resist-all'] + calc.attr('lightning-resist');
		resists['resist-poison'] = resists['resist-all'] + calc.attr('poison-resist');
		resists['resist-arcane'] = resists['resist-all'] + calc.attr('arcane-resist');
		return resists;
	},
	armor: function(calc) {
		// ----------------------------------
