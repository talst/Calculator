...
Calc.math = {
	...
	ehp: function(calc) {
		...
		if(calc.build['class'] === "monk" || calc.build['class'] === "barbarian") {
			...
			// ----------------------------------
			damageTaken = ( 1 - calc.stats.resists.percent['all'] ) * ( 1 - calc.stats.reductions.armor ) * ( 1 - 0.3 );
			// ----------------------------------
			...
			// ----------------------------------
			ehp['arcane'] = calc.stats.life / ( ( 1 - calc.stats.reductions.armor ) * ( 1 - calc.stats.resists.percent['arcane']	) * (1 - 0.3) );
			ehp['cold'] = calc.stats.life / ( ( 1 - calc.stats.reductions.armor ) * ( 1 - calc.stats.resists.percent['cold'] ) * (1 - 0.3) );
			ehp['fire'] = calc.stats.life / ( ( 1 - calc.stats.reductions.armor ) * ( 1 - calc.stats.resists.percent['fire'] ) * (1 - 0.3) );
			ehp['lightning'] = calc.stats.life / ( ( 1 - calc.stats.reductions.armor ) * ( 1 - calc.stats.resists.percent['lightning']) * (1 - 0.3) );
			ehp['physical'] = calc.stats.life / ( ( 1 - calc.stats.reductions.armor ) * ( 1 - calc.stats.resists.percent['physical']) * (1 - 0.3) );
			ehp['poison'] = calc.stats.life / ( ( 1 - calc.stats.reductions.armor ) * ( 1 - calc.stats.resists.percent['poison']	) * (1 - 0.3) );
		} else {
			// ----------------------------------
			// Damage Taken Percent
	...
	resists: function(calc) {
		...
		// ----------------------------------		
		resists.percent = {};
		resists.percent['all'] = resists['all'] / (5 * calc.settings.vsLevel + resists['all']);
		resists.percent['physical'] = resists['physical'] / (5 * calc.settings.vsLevel + resists['physical']);
		resists.percent['cold'] = resists['cold'] / (5 * calc.settings.vsLevel + resists['cold']);
		resists.percent['fire'] = resists['fire'] / (5 * calc.settings.vsLevel + resists['fire']);
		resists.percent['lightning'] = resists['lightning'] / (5 * calc.settings.vsLevel + resists['lightning']);
		resists.percent['poison'] = resists['poison'] / (5 * calc.settings.vsLevel + resists['poison']);
		resists.percent['arcane'] = resists['arcane'] / (5 * calc.settings.vsLevel + resists['arcane']);
		// Return the resists
	...
	speeds: function(calc) {
		...
		if(oh && oh.stats && oh.stats.speed) {
			// If we have a weapon as an OH, assume we are DW
			speeds.dw = true;
